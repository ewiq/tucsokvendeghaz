...
<svelte:head>
    <title>Tücsök Vendégház | Adatvédelmi tájékoztató</title>
    <meta name="description" content="A Tücsök Vendégház adatvédelmi tájékoztatója." />
            ...
            <div class="max-w-6xl mx-auto pt-8">
                <div class="bg-white rounded-lg p-6 md:p-8 space-y-6">
                    <div class="text-gray-700 leading-relaxed space-y-8">
                        <p class="text-lg">
                            A Tücsök Vendégház. (továbbiakban: Vendégház) tájékoztatja Önt arról, hogy a jelen honlap használata során (elektronikus levél küldése) személyes adatokat ad meg. A személyes adatok kezelésről, a személyes adatok védelméről az alábbiak szerint tájékoztatjuk:
                        </p>
                        ...
                        <ul class="list-disc pl-6 space-y-2 text-lg">
                            <li>Általános Adatvédelmi Rendelet (GDPR) 6. cikk.(1) bek. a. és b. pontok</li>
                            <li>érintett beleegyezése (az információs önrendelkezési jogról és az információszabadságról szóló 2011. évi CXII. törvény 5. § (1) a),</li>
                        </ul>
                        ...
                        <div class="space-y-4">
                            <h3 class="text-2xl font-semibold text-gray-800 mt-8 mb-4">Adatkezelés fogalma</h3>
                            <p class="text-lg">
                        ...
                        <div class="space-y-4">
                            <h3 class="text-2xl font-semibold text-gray-800 mt-8 mb-4">Technikai adatok</h3>
                            <p class="text-lg">
                        ...
                        <div class="space-y-4">
                            <h3 class="text-2xl font-semibold text-gray-800 mt-8 mb-4">Adatkezelés célja és időtartama</h3>
                            <p class="text-lg">
                        ...
                        <div class="space-y-4">
                            <h3 class="text-2xl font-semibold text-gray-800 mt-8 mb-4">Adatok védelme</h3>
                            <p class="text-lg">
                        ...
                        <div class="space-y-4">
                            <h3 class="text-2xl font-semibold text-gray-800 mt-8 mb-4">Tájékoztatás és jogorvoslat</h3>
                            <p class="text-lg">
                            ...
                            <p class="text-lg">
                                Az érintett a jogainak megsértése esetén az adatkezelő ellen bírósághoz fordulhat. A perre a Budapest Környéki Törvényszék az illetékes, azonban a per – az érintett választása szerint – az érintett lakóhelye (tartózkodási helye) szerinti törvényszék előtt is megindítható.
                            </p>
                        </div>
                        
                        <div class="space-y-4">
                            <h3 class="text-2xl font-semibold text-gray-800 mt-8 mb-4">Tiltakozás az adatkezelés ellen:</h3>
                            <p class="text-lg">
